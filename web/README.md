...
WP0 (scaffold), WP1 (the CTL/ATL/TSB engine in [`src/core/`](src/core) with
Vitest parity tests against the Python implementation) and WP2 (the upload and
chart UI) are done. Design polish is next.
